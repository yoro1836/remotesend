...
class SettingsStateMapper extends ClassMapperBase<SettingsState> {
  ...
  static bool _$quickShareEnabled(SettingsState v) => v.quickShareEnabled;
  static const Field<SettingsState, bool> _f$quickShareEnabled = Field(
    'quickShareEnabled',
    _$quickShareEnabled,
  );
  ...
  final MappableFields<SettingsState> fields = const {
    ...
    #quickShareEnabled: _f$quickShareEnabled,
  };
  ...
  static SettingsState _instantiate(DecodingData data) {
    return SettingsState(
      ...
      quickShareEnabled: data.dec(_f$quickShareEnabled),
    );
  }
...
class _SettingsStateCopyWithImpl<$R, $Out>
  ...
  $R call({
    ...
    FieldCopyWithData({
      ...
      if (quickShareEnabled != null) #quickShareEnabled: quickShareEnabled,
    }),
  );
  @override
  SettingsState $make(CopyWithData data) => SettingsState(
    ...
    quickShareEnabled: data.get(
      #quickShareEnabled,
      or: $value.quickShareEnabled,
    ),
  );
