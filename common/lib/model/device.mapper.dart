...
class DiscoveryMethodMapper extends ClassMapperBase<DiscoveryMethod> {
  ...
  static DiscoveryMethodMapper ensureInitialized() {
    if (_instance == null) {
      ...
      QuickShareDiscoveryMapper.ensureInitialized();
    }
    return _instance!;
  }
...
class QuickShareDiscoveryMapper extends ClassMapperBase<QuickShareDiscovery> {
  QuickShareDiscoveryMapper._();

  static QuickShareDiscoveryMapper? _instance;
  static QuickShareDiscoveryMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = QuickShareDiscoveryMapper._());
      DiscoveryMethodMapper.ensureInitialized();
    }
    return _instance!;
  }
  ...
  @override
  final String id = 'QuickShareDiscovery';

  @override
  final MappableFields<QuickShareDiscovery> fields = const {};

  static QuickShareDiscovery _instantiate(DecodingData data) {
    return QuickShareDiscovery();
  }

  @override
  final Function instantiate = _instantiate;

  static QuickShareDiscovery fromJson(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<QuickShareDiscovery>(map);
  }

  static QuickShareDiscovery deserialize(String json) {
    return ensureInitialized().decodeJson<QuickShareDiscovery>(json);
  }
}

mixin QuickShareDiscoveryMappable {
  String serialize() {
    return QuickShareDiscoveryMapper.ensureInitialized()
        .encodeJson<QuickShareDiscovery>(this as QuickShareDiscovery);
  }

  Map<String, dynamic> toJson() {
    return QuickShareDiscoveryMapper.ensureInitialized()
        .encodeMap<QuickShareDiscovery>(this as QuickShareDiscovery);
  }

  QuickShareDiscoveryCopyWith<
    QuickShareDiscovery,
    QuickShareDiscovery,
    QuickShareDiscovery
  >
  get copyWith =>
      _QuickShareDiscoveryCopyWithImpl<
        QuickShareDiscovery,
        QuickShareDiscovery
      >(this as QuickShareDiscovery, $identity, $identity);
  @override
  String toString() {
    return QuickShareDiscoveryMapper.ensureInitialized().stringifyValue(
      this as QuickShareDiscovery,
    );
  }

  @override
  bool operator ==(Object other) {
    return QuickShareDiscoveryMapper.ensureInitialized().equalsValue(
      this as QuickShareDiscovery,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return QuickShareDiscoveryMapper.ensureInitialized().hashValue(
      this as QuickShareDiscovery,
    );
  }
}

extension QuickShareDiscoveryValueCopy<$R, $Out>
    on ObjectCopyWith<$R, QuickShareDiscovery, $Out> {
  QuickShareDiscoveryCopyWith<$R, QuickShareDiscovery, $Out>
  get $asQuickShareDiscovery => $base.as(
    (v, t, t2) => _QuickShareDiscoveryCopyWithImpl<$R, $Out>(v, t, t2),
  );
}

abstract class QuickShareDiscoveryCopyWith<
  $R,
  $In extends QuickShareDiscovery,
  $Out
>
    implements DiscoveryMethodCopyWith<$R, $In, $Out> {
  @override
  $R call();
  QuickShareDiscoveryCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
    Then<$Out2, $R2> t,
  );
}

class _QuickShareDiscoveryCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, QuickShareDiscovery, $Out>
    implements QuickShareDiscoveryCopyWith<$R, QuickShareDiscovery, $Out> {
  _QuickShareDiscoveryCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<QuickShareDiscovery> $mapper =
      QuickShareDiscoveryMapper.ensureInitialized();
  @override
  $R call() => $apply(FieldCopyWithData({}));
  @override
  QuickShareDiscovery $make(CopyWithData data) => QuickShareDiscovery();

  @override
  QuickShareDiscoveryCopyWith<$R2, QuickShareDiscovery, $Out2>
  $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
      _QuickShareDiscoveryCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
